...
ApplicationWindow {
    ...
    property color mainAppColor: "#2196F3"
    property color mainTextCOlor: "#f0f0f0"
    property color popupBackGroundColor: "#2196F3"
    ...
    FontLoader {
        id: fontAwesome
        name: "fontawesome"
        source: "qrc:/LoginStuff/fontawesome-webfont.ttf"
    }
    ...
    Component.onCompleted: {
        stackView.push("qrc:/LoginStuff/LogInPage.qml")   //initial page
    ...
    {
        var db = LocalStorage.openDatabaseSync("LoginApp", "1.0", "Login Window", 1000000);
    ...
    {
//        stackView.replace("qrc:/LoginStuff/UserInfoPage.qml", {"userName": uname})
        var adminComponent = Qt.createComponent("qrc:/AdminStuff/Admin.qml");
        console.log("Component Status:", adminComponent.status, adminComponent.errorString());
        var admin = adminComponent.createObject(rootWindow);
        rootWindow.close();
        admin.show();
    }
    ...
    {
        stackView.replace("qrc:/LoginStuff/LogInPage.qml")
    }

    // Show Password reset page
    function forgotPassword()
    {
        stackView.replace("qrc:/LoginStuff/PasswordResetPage.qml")
    }
